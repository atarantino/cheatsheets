...
\definecolor{macoscolor}{RGB}{0,120,215}
...
\begin{macbox}
\textbf{Launch \& Switch Apps}\\
\keyline{Cmd+Space}{Spotlight / Raycast / Alfred}\\
\keyline{Cmd+\textasciitilde}{Cycle that app's windows}\\
\keyline{Cmd+Tab}{Switch apps}\\
\textit{Alternative: AltTab \href{https://github.com/lwouis/alt-tab-macos}{github.com/lwouis/alt-tab-macos}}
\end{macbox}
...
\end{macbox}
\begin{macbox}
\textbf{Rectangle} \href{https://github.com/rxhanson/Rectangle}{github.com/rxhanson/Rectangle}\\
\keyline{Ctrl+Opt+Left/Right}{Snap window left/right}\\
\keyline{Ctrl+Opt+Enter}{Maximize window}
\end{macbox}
\begin{macbox}
\textbf{Raycast} \href{https://www.raycast.com}{raycast.com}\\
\textbf{Tip:} Enable Hyper key in settings and assign hotkeys\\
\keyline{Hyper+Left/Right}{Snap window left/right}\\
\keyline{Hyper+Up}{Maximize window}
\end{macbox}

\begin{macbox}
\textbf{Misc.}\\
\keyline{Ctrl+Cmd+Space}{Emoji \& symbols}
\end{macbox}
...
\keyline{Ctrl+Tab}{Next tab (Chrome/Firefox)}\\
\keyline{Cmd+Shift+]}{Next tab (Safari)}\\
...
\keyline{Cmd+Shift+G}{Go to channel}\\
\keyline{Cmd+/}{Show slash commands}
\end{macbox}

\section*{Finder}

\begin{macbox}
\keyline{Cmd+Shift+N}{New folder}\\
\keyline{Cmd+Shift+G}{Go to folder}\\
\keyline{Cmd+Up}{Parent folder}\\
\keyline{Cmd+Down}{Open selected item}\\
\keyline{Cmd+[}{Back}\\
\keyline{Cmd+]}{Forward}\\
\keyline{Cmd+Delete}{Move to trash}\\
\keyline{Space}{Quick Look}\\
\keyline{Enter}{Rename selected item}\\
\keyline{Cmd+Opt+P}{Toggle Path Bar}\\
\keyline{Cmd+Opt+T}{Toggle Toolbar}\\
\keyline{Cmd+Opt+S}{Toggle Sidebar}
\end{macbox}

\section*{Raycast}
\textit{\footnotesize Suite of productivity tools \href{https://www.raycast.com}{raycast.com}}
\begin{macbox}
\keyline{Cmd+Space}{Launch Raycast (rebind from Spotlight)}\\
App launcher, window mgmt, keyboard shortcuts\\
\textit{Alternatives:}\\
\textbf{Alfred} \href{https://www.alfredapp.com/}{alfredapp.com} - suite of tools\\
\textbf{Kanata} \href{https://github.com/jtroo/kanata}{github.com/jtroo/kanata}-  keyboard remapper\\
\textbf{Maccy} \href{https://github.com/p0deje/Maccy}{github.com/p0deje/Maccy} - clipboard manager
\end{macbox}
...
\begin{macbox}
\textbf{Open Source Tiling window managers}\\
• \textbf{Aerospace} - i3-like, keyboard-driven\\
• \textbf{yabai} - BSP tiling, advanced features
\end{macbox}
