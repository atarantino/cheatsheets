...
\fancyfoot[R]{\footnotesize\color{footgray} Adam Tarantino \textbullet\ \url{https://github.com/atarantino/cheetsheets}}
...
\keyline{F12 / Ctrl+Shift+I}{Open DevTools}
\end{windowsbox}
...
\section*{PowerToys}
\textit{\footnotesize Open source utilities from Microsoft}
\begin{windowsbox}
\keyline{Alt+Space}{Command Palette\textemdash{run commands and apps}}\\
